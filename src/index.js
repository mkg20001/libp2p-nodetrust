...
const defaultNode = new Peer(Id.createFromB58String('QmW32XgTkM7UqHm7U6GfLcZfncArSLvMHxQZWSRhGrnLYg'))

if (process && process.toString() === '[object process]') {
  defaultNode.multiaddrs.add('/ip4/136.243.31.32/tcp/8899/ipfs/QmW32XgTkM7UqHm7U6GfLcZfncArSLvMHxQZWSRhGrnLYg')
} else {
  defaultNode.multiaddrs.add('/dnsaddr/libp2p-nodetrust.tk/tcp/443/wss/ipfs/QmW32XgTkM7UqHm7U6GfLcZfncArSLvMHxQZWSRhGrnLYg')
}
